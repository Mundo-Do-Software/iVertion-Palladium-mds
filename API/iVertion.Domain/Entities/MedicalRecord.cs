...
namespace iVertion.Domain.Entities
{
    public sealed class MedicalRecord : Entity
    {
        ...
        public MedicalRecord(DateTime lastMedicalExamDate,
                             ...
                             bool active)
        {
            ValidationDomain(lastMedicalExamDate,
                             lastMedicalExamResult,
                             ...
                             physicalRestrictionsDescription,
                             hasMedicalLimitations,
                             medicalLimitationsDescription,
                             notes,
                             bloodType,
                             medicalHistory,
                             vaccinationHistory,
        ...
        public void Update(DateTime lastMedicalExamDate,
                           string lastMedicalExamResult,
                           bool hasMedicalConditions,
                           string? medicalConditions,
                           bool hasAllergies,
